          ...
          <main class="px-16 py-6 bg-gray-100 md:col-span-2">
              ...
              <div>
                  ...
                  <div class="mt-8 mb-8 grid lg:grid-cols-3 gap-10">
                      ...
                      <div class="card hover:shadow-xl transform hover:-translate-y-1 transition-all ease-in-out duration-300">
                          ...
                          <div class="m-4">
                              ...
                              <span class="block text-gray-500 text-sm">Recipe by Carmen</span>
                          </div>
                          <div class="badge">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 inline-block">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                  ...
                  <div class="flex justify-center">
                      <div class="btn bg-secondary-100 text-secondary-200 hover:shadow-inner transform hover:scale-110 hover:bg-opacity-50 transition ease-out duration-300">Load more</div>
                  </div>
                  ...
                  <div class="mt-8 mb-8 grid lg:grid-cols-3 gap-10">
                      ...
                      <div class="card hover:shadow-xl transform hover:-translate-y-1 transition-all ease-in-out duration-300">
                          ...
                          <div class="m-4">
                              ...
                              <span class="block text-gray-500 text-sm">Recipe by Katarina</span>
                          </div>
                          <div class="badge">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 inline-block">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                      ...
                      <div class="card hover:shadow-xl transform hover:-translate-y-1 transition-all ease-in-out duration-300">
                          ...
                          <div class="m-4">
                              ...
                              <span class="block text-gray-500 text-sm">Recipe by Roger</span>
                          </div>
                          <div class="badge">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 inline-block">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
